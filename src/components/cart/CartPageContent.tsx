    ...
    return (
      <main className="min-h-[60vh] flex items-center justify-center bg-warm-white">
        <div className="text-center px-4">
          ...
          <Link
            href="/shop"
            className="inline-flex items-center gap-2 px-6 py-3 bg-crimson text-white font-bold rounded-xl shadow-md"
          >
            🛒 Shop Now
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {items.map(({ product, quantity }) => (
              ...
              >
                ...
                <button
                  ...
                  className="shrink-0 w-7 h-7 rounded-lg text-zinc-300 hover:text-red-500 hover:bg-red-50 flex items-center justify-center transition-colors text-sm cursor-pointer"
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl border border-zinc-100 p-5 shadow-sm sticky top-24">
              ...
              <Link
                href="/checkout"
                className="block w-full py-4 bg-crimson text-white text-sm font-bold rounded-2xl text-center hover:bg-[#991B1B] shadow-[0_4px_20px_rgba(185,28,28,0.3)] transition-all"
              >
                PROCEED TO CHECKOUT →
              </Link>
