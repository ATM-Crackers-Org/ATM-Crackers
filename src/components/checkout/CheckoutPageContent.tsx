    ...
    return (
      <main className="min-h-[65vh] flex items-center justify-center bg-warm-white px-4">
        <div className="text-center max-w-md bg-white p-8 rounded-3xl border border-zinc-100 shadow-sm">
          ...
          <Link
            href="/shop"
            className="inline-flex items-center gap-2 px-6 py-3 bg-crimson text-white font-bold rounded-xl shadow-md hover:bg-[#991B1B] transition-colors"
          >
            Shop Crackers Now
          </Link>
        </div>
    ...
    <main className="min-h-screen bg-warm-white py-8">
      <div className="max-w-[1280px] mx-auto px-4 md:px-6 lg:px-8">
        ...
        <nav className="flex items-center gap-2 text-xs text-zinc-400 mb-6">
          ...
          <span>›</span>
          <Link href="/cart" className="hover:text-crimson">Cart</Link>
          <span>›</span>
              ...
              {[
                ...
                <React.Fragment key={s.num}>
                  <div className="flex flex-col items-center">
                    ...
                    <span
                      className={`text-xs font-semibold mt-1.5 ${step >= s.num ? "text-zinc-900" : "text-zinc-400"
                        }`}
                    >
                      {s.label}
                    </span>
                  ...
                  {idx < 2 && (
                    <div
                      className={`flex-1 h-0.5 mx-3 transition-colors ${step > s.num ? "bg-crimson" : "bg-zinc-200"
                        }`}
                    />
                  )}
                </React.Fragment>
          ...
          <div className="max-w-2xl mx-auto bg-white rounded-3xl p-8 md:p-12 border border-zinc-100 shadow-xl text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                ...
                className="px-6 py-3.5 bg-crimson text-white font-bold rounded-xl shadow-md hover:bg-[#991B1B] transition-colors text-sm"
              >
                📍 Track Your Order
              </Link>
              <a
                ...
                <div className="bg-white rounded-3xl p-6 md:p-8 border border-zinc-100 shadow-sm">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="sm:col-span-2">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border border-zinc-200 rounded-xl text-sm outline-none focus:border-crimson"
                      />
                    </div>
                  ...
                  <div className="mt-8 flex justify-end">
                    <button
                      ...
                      className="px-8 py-3.5 bg-crimson text-white font-bold rounded-xl hover:bg-[#991B1B] shadow-md transition-colors text-sm cursor-pointer"
                    >
              ...
              {step === 2 && (
                <div className="bg-white rounded-3xl p-6 md:p-8 border border-zinc-100 shadow-sm">
                  ...
                  <div className="space-y-3">
                    <label
                      className={`flex items-start gap-4 p-4 rounded-2xl border-2 cursor-pointer transition-all ${formData.deliveryOption === "standard"
                        ? "border-crimson bg-red-50/20"
                    ...
                    <label
                      className={`flex items-start gap-4 p-4 rounded-2xl border-2 cursor-pointer transition-all ${formData.deliveryOption === "express"
                        ? "border-crimson bg-red-50/20"
                        : "border-zinc-200 hover:border-zinc-300"
                        }`}
                    >
                ...
                <div className="bg-white rounded-3xl p-6 md:p-8 border border-zinc-100 shadow-sm">
                  ...
                  <div className="space-y-3 mb-6">
                    {[
                      ...
                      <label
                        key={pm.id}
                        className={`flex items-start gap-4 p-4 rounded-2xl border-2 cursor-pointer transition-all ${formData.paymentMethod === pm.id
                          ? "border-crimson bg-red-50/20"
                          : "border-zinc-200 hover:border-zinc-300"
                          }`}
                      >
                  ...
                  <div className="flex justify-between">
                    ...
                    <button
                      ...
                      className="px-8 py-3.5 bg-crimson text-white font-bold rounded-xl hover:bg-[#991B1B] shadow-lg transition-all text-sm cursor-pointer"
                    >
                ...
                <div className="mb-5 pt-4 border-t border-zinc-100">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-3 py-2 border border-zinc-200 rounded-xl text-xs uppercase outline-none focus:border-crimson"
                    />
                    <button
                      type="button"
